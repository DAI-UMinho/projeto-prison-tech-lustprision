...
public class QuizController implements Initializable {
    ...
    public void handlebuttonIniciar(ActionEvent actionEvent) throws IOException {
        System.out.println("Botão Iniciar");
        Parent iniciar_parent = FXMLLoader.load(getClass().getResource("/sample/view/Perguntas.fxml"));
