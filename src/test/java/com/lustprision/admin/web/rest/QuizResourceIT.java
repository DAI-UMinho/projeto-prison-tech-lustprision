...
public class QuizResourceIT {
    ...
    private static final Integer DEFAULT_QUEST_QUIZ_ID = 1;
    private static final Integer UPDATED_QUEST_QUIZ_ID = 2;
    ...
    public static Quiz createEntity(EntityManager em) {
        Quiz quiz = new Quiz()
            ...
            .questQuizId(DEFAULT_QUEST_QUIZ_ID)
    ...
    public static Quiz createUpdatedEntity(EntityManager em) {
        Quiz quiz = new Quiz()
            ...
            .questQuizId(UPDATED_QUEST_QUIZ_ID)
    ...
    public void createQuiz() throws Exception {
        ...
        assertThat(testQuiz.getQuestQuizId()).isEqualTo(DEFAULT_QUEST_QUIZ_ID);
    ...
    public void getAllQuizzes() throws Exception {
        ...
        restQuizMockMvc.perform(get("/api/quizzes?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].questQuizId").value(hasItem(DEFAULT_QUEST_QUIZ_ID)))
    ...
    public void getQuiz() throws Exception {
        ...
        restQuizMockMvc.perform(get("/api/quizzes/{id}", quiz.getId()))
            ...
            .andExpect(jsonPath("$.questQuizId").value(DEFAULT_QUEST_QUIZ_ID))
    ...
    public void updateQuiz() throws Exception {
        ...
        assertThat(testQuiz.getQuestQuizId()).isEqualTo(UPDATED_QUEST_QUIZ_ID);
