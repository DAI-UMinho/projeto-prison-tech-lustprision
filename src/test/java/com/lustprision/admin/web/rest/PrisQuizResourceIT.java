...
public class PrisQuizResourceIT {
    ...
    public void createPrisQuiz() throws Exception {
        ...
        assertThat(testPrisQuiz.getIdPrisioner()).isEqualTo(DEFAULT_ID_PRISIONER);
        assertThat(testPrisQuiz.getIdQuiz()).isEqualTo(DEFAULT_ID_QUIZ);
    ...
    public void updatePrisQuiz() throws Exception {
        ...
        PrisQuiz testPrisQuiz = prisQuizList.get(prisQuizList.size() - 1);
        assertThat(testPrisQuiz.getIdPrisioner()).isEqualTo(UPDATED_ID_PRISIONER);
        assertThat(testPrisQuiz.getIdQuiz()).isEqualTo(UPDATED_ID_QUIZ);
