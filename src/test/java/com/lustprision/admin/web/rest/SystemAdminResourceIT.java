...
public class SystemAdminResourceIT {
    ...
    private static final String DEFAULT_USER_NAME_ADMIN = "AAAAAAAAAA";
    private static final String UPDATED_USER_NAME_ADMIN = "BBBBBBBBBB";
    ...
    public static SystemAdmin createEntity(EntityManager em) {
        SystemAdmin systemAdmin = new SystemAdmin()
            ...
            .userNameAdmin(DEFAULT_USER_NAME_ADMIN)
    ...
    public static SystemAdmin createUpdatedEntity(EntityManager em) {
        SystemAdmin systemAdmin = new SystemAdmin()
            ...
            .userNameAdmin(UPDATED_USER_NAME_ADMIN)
    ...
    public void createSystemAdmin() throws Exception {
        ...
        assertThat(testSystemAdmin.getUserNameAdmin()).isEqualTo(DEFAULT_USER_NAME_ADMIN);
        assertThat(testSystemAdmin.getPassword()).isEqualTo(DEFAULT_PASSWORD);
        assertThat(testSystemAdmin.getPermissionIdPermission()).isEqualTo(DEFAULT_PERMISSION_ID_PERMISSION);
    }
    ...
    public void getAllSystemAdmins() throws Exception {
        ...
        restSystemAdminMockMvc.perform(get("/api/system-admins?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].userNameAdmin").value(hasItem(DEFAULT_USER_NAME_ADMIN)))
    ...
    public void getSystemAdmin() throws Exception {
        ...
        restSystemAdminMockMvc.perform(get("/api/system-admins/{id}", systemAdmin.getId()))
            ...
            .andExpect(jsonPath("$.userNameAdmin").value(DEFAULT_USER_NAME_ADMIN))
    ...
    public void updateSystemAdmin() throws Exception {
        ...
        assertThat(testSystemAdmin.getUserNameAdmin()).isEqualTo(UPDATED_USER_NAME_ADMIN);
        assertThat(testSystemAdmin.getPassword()).isEqualTo(UPDATED_PASSWORD);
        assertThat(testSystemAdmin.getPermissionIdPermission()).isEqualTo(UPDATED_PERMISSION_ID_PERMISSION);
    }
