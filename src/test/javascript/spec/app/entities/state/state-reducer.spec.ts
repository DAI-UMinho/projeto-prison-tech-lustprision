...
import reducer, { ACTION_TYPES, getEntities, getEntity, reset } from 'app/entities/state/state.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Failures', () => {
    it('should set a message in errorMessage', () => {
      testMultipleTypes([FAILURE(ACTION_TYPES.FETCH_STATE_LIST), FAILURE(ACTION_TYPES.FETCH_STATE)], 'error message', state => {
        expect(state).toMatchObject({
