...
describe('AdminEmploy e2e test', () => {
  ...
  it('should create and save AdminEmploys', async () => {
    ...
    await adminEmployUpdatePage.setLoginUserNameInput('loginUserName');
    expect(await adminEmployUpdatePage.getLoginUserNameInput()).to.match(/loginUserName/);
    ...
    await adminEmployUpdatePage.setPermissionIdPermissionInput('5');
    expect(await adminEmployUpdatePage.getPermissionIdPermissionInput()).to.eq('5');
    await adminEmployUpdatePage.idPermissionSelectLastOption();
