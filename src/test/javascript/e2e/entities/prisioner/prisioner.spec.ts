...
describe('Prisioner e2e test', () => {
  ...
  it('should create and save Prisioners', async () => {
    ...
    await prisionerUpdatePage.setLoginUserNameInput('loginUserName');
    expect(await prisionerUpdatePage.getLoginUserNameInput()).to.match(/loginUserName/);
    await prisionerUpdatePage.setPermissinidPermissionInput('5');
    expect(await prisionerUpdatePage.getPermissinidPermissionInput()).to.eq('5');
    ...
    await prisionerUpdatePage.idPermissionSelectLastOption();
