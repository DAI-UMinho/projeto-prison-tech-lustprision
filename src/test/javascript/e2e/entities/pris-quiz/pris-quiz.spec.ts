...
describe('PrisQuiz e2e test', () => {
  ...
  it('should create and save PrisQuizs', async () => {
    await prisQuizComponentsPage.createButton.click();
    await prisQuizUpdatePage.setIdPrisionerInput('5');
    expect(await prisQuizUpdatePage.getIdPrisionerInput()).to.eq('5');
    await prisQuizUpdatePage.setIdQuizInput('5');
    expect(await prisQuizUpdatePage.getIdQuizInput()).to.eq('5');
    await prisQuizUpdatePage.setQuizDateInput('01-01-2001');
    expect(await prisQuizUpdatePage.getQuizDateInput()).to.eq('2001-01-01');
    await prisQuizUpdatePage.idQuizSelectLastOption();
    await prisQuizUpdatePage.idPrisionerSelectLastOption();
