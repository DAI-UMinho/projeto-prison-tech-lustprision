...
describe('QuestionQuiz e2e test', () => {
  ...
  it('should create and save QuestionQuizs', async () => {
    await questionQuizComponentsPage.createButton.click();
    await questionQuizUpdatePage.setQuestionQuizIdInput('5');
    expect(await questionQuizUpdatePage.getQuestionQuizIdInput()).to.eq('5');
    await questionQuizUpdatePage.setIdQuizInput('5');
    expect(await questionQuizUpdatePage.getIdQuizInput()).to.eq('5');
    await questionQuizUpdatePage.setIdQuestionInput('5');
    expect(await questionQuizUpdatePage.getIdQuestionInput()).to.eq('5');
    await questionQuizUpdatePage.idQuizSelectLastOption();
    await questionQuizUpdatePage.idQuestionSelectLastOption();
