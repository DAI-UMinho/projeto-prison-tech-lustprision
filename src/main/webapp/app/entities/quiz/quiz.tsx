...
export const Quiz = (props: IQuizProps) => {
  ...
  const { quizList, match, loading } = props;
  return (
    <div>
      <h2 id="quiz-heading">
        <Translate contentKey="lustPrisionApp.quiz.home.title">Quizzes</Translate>
        <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
          <FontAwesomeIcon icon="plus" />
          &nbsp;
          <Translate contentKey="lustPrisionApp.quiz.home.createLabel">Create new Quiz</Translate>
        </Link>
      </h2>
        ...
        {quizList && quizList.length > 0 ? (
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="lustPrisionApp.quiz.home.notFound">No Quizzes found</Translate>
            </div>
          )
        )}
      </div>
