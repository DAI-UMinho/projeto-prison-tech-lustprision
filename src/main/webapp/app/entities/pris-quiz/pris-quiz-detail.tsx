    ...
    <Row>
      <Col md="8">
        ...
        <dl className="jh-entity-details">
          ...
          <dd>{prisQuizEntity.idQuiz ? prisQuizEntity.idQuiz.id : ''}</dd>
          <dt>
            <Translate contentKey="lustPrisionApp.prisQuiz.idPrisioner">Id Prisioner</Translate>
          </dt>
          <dd>{prisQuizEntity.idPrisioner ? prisQuizEntity.idPrisioner.id : ''}</dd>
        </dl>
