            ...
            <tbody>
              {prisQuizList.map((prisQuiz, i) => (
                <tr key={`entity-${i}`}>
                  ...
                  <td>{prisQuiz.idPrisioner}</td>
                  <td>{prisQuiz.idQuiz}</td>
                  <td>
                    <TextFormat type="date" value={prisQuiz.quizDate} format={APP_LOCAL_DATE_FORMAT} />
                  </td>
                  <td>{prisQuiz.idQuiz ? <Link to={`quiz/${prisQuiz.idQuiz.id}`}>{prisQuiz.idQuiz.id}</Link> : ''}</td>
                  <td>{prisQuiz.idPrisioner ? <Link to={`prisioner/${prisQuiz.idPrisioner.id}`}>{prisQuiz.idPrisioner.id}</Link> : ''}</td>
