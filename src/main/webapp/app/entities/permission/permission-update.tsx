        ...
        <Col md="8">
          {loading ? (
            ...
            <AvForm model={isNew ? {} : permissionEntity} onSubmit={saveEntity}>
              ...
              <AvGroup>
                <Label id="idPremissinLabel" for="permission-idPremissin">
                  <Translate contentKey="lustPrisionApp.permission.idPremissin">Id Premissin</Translate>
                </Label>
                <AvField id="permission-idPremissin" type="string" className="form-control" name="idPremissin" />
              </AvGroup>
              <AvGroup>
