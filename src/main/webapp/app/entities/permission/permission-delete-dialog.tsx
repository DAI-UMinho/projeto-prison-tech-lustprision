...
export const PermissionDeleteDialog = (props: IPermissionDeleteDialogProps) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="lustPrisionApp.permission.delete.question">
        <Translate contentKey="lustPrisionApp.permission.delete.question" interpolate={{ id: permissionEntity.id }}>
      ...
      <ModalFooter>
        ...
        <Button id="jhi-confirm-delete-permission" color="danger" onClick={confirmDelete}>
