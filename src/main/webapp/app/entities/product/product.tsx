  ...
  return (
    <div>
      <h2 id="product-heading">
        <Translate contentKey="lustPrisionApp.product.home.title">Products</Translate>
        <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
          <FontAwesomeIcon icon="plus" />
          &nbsp;
          <Translate contentKey="lustPrisionApp.product.home.createLabel">Create new Product</Translate>
        </Link>
      </h2>
        ...
        {productList && productList.length > 0 ? (
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="lustPrisionApp.product.home.notFound">No Products found</Translate>
            </div>
          )
        )}
      </div>
