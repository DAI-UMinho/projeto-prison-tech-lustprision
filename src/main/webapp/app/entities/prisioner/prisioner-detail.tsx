    ...
    <Row>
      <Col md="8">
        ...
        <dl className="jh-entity-details">
          ...
          <dd>{prisionerEntity.loginUserName}</dd>
          <dt>
            <span id="permissinidPermission">
              <Translate contentKey="lustPrisionApp.prisioner.permissinidPermission">Permissinid Permission</Translate>
            </span>
          </dt>
          <dd>{prisionerEntity.permissinidPermission}</dd>
          <dt>
            <span id="working">
          ...
          <dd>{prisionerEntity.idPermission ? prisionerEntity.idPermission.id : ''}</dd>
          <dt>
