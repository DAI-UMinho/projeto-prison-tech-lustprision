...
export const PrisionerUpdate = (props: IPrisionerUpdateProps) => {
  ...
  const { prisionerEntity, permissions, logins, loading, updating } = props;
        ...
        <Col md="8">
          {loading ? (
            ...
            <AvForm model={isNew ? {} : prisionerEntity} onSubmit={saveEntity}>
              ...
              <AvGroup>
                <Label id="loginUserNameLabel" for="prisioner-loginUserName">
                  <Translate contentKey="lustPrisionApp.prisioner.loginUserName">Login User Name</Translate>
                </Label>
                <AvField id="prisioner-loginUserName" type="text" name="loginUserName" />
              </AvGroup>
              <AvGroup>
                <Label id="permissinidPermissionLabel" for="prisioner-permissinidPermission">
                  <Translate contentKey="lustPrisionApp.prisioner.permissinidPermission">Permissinid Permission</Translate>
                </Label>
                <AvField id="prisioner-permissinidPermission" type="string" className="form-control" name="permissinidPermission" />
              </AvGroup>
              <AvGroup>
              ...
              <AvGroup>
                <Label for="prisioner-idPermission">
                  <Translate contentKey="lustPrisionApp.prisioner.idPermission">Id Permission</Translate>
                </Label>
                <AvInput id="prisioner-idPermission" type="select" className="form-control" name="idPermission.id">
                  <option value="" key="0" />
                  {permissions
