...
export const PurchaseDeleteDialog = (props: IPurchaseDeleteDialogProps) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="lustPrisionApp.purchase.delete.question">
        <Translate contentKey="lustPrisionApp.purchase.delete.question" interpolate={{ id: purchaseEntity.id }}>
      ...
      <ModalFooter>
        ...
        <Button id="jhi-confirm-delete-purchase" color="danger" onClick={confirmDelete}>
