            ...
            <tbody>
              {systemAdminList.map((systemAdmin, i) => (
                <tr key={`entity-${i}`}>
                  ...
                  <td>{systemAdmin.userNameAdmin}</td>
                  <td>{systemAdmin.password}</td>
                  <td>{systemAdmin.permissionIdPermission}</td>
                  <td>
                    {systemAdmin.idPermission ? (
                      <Link to={`permission/${systemAdmin.idPermission.id}`}>{systemAdmin.idPermission.id}</Link>
                    ) : (
                      ''
                    )}
                  </td>
