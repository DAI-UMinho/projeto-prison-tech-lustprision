            ...
            <tbody>
              {pressProductList.map((pressProduct, i) => (
                <tr key={`entity-${i}`}>
                  ...
                  <td>
                    {pressProduct.purchase ? <Link to={`purchase/${pressProduct.purchase.id}`}>{pressProduct.purchase.id}</Link> : ''}
                  </td>
                  <td>{pressProduct.product ? <Link to={`product/${pressProduct.product.id}`}>{pressProduct.product.id}</Link> : ''}</td>
