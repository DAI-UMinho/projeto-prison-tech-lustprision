    ...
    <Row>
      <Col md="8">
        ...
        <dl className="jh-entity-details">
          <dt>
            <span id="questionQuizId">
              <Translate contentKey="lustPrisionApp.questionQuiz.questionQuizId">Question Quiz Id</Translate>
            </span>
          </dt>
          <dd>{questionQuizEntity.questionQuizId}</dd>
          <dt>
            <span id="idQuiz">
              <Translate contentKey="lustPrisionApp.questionQuiz.idQuiz">Id Quiz</Translate>
            </span>
          </dt>
          <dd>{questionQuizEntity.idQuiz}</dd>
          <dt>
            <span id="idQuestion">
              <Translate contentKey="lustPrisionApp.questionQuiz.idQuestion">Id Question</Translate>
            </span>
          </dt>
          <dd>{questionQuizEntity.idQuestion}</dd>
          <dt>
            <Translate contentKey="lustPrisionApp.questionQuiz.idQuiz">Id Quiz</Translate>
          </dt>
          <dd>{questionQuizEntity.idQuiz ? questionQuizEntity.idQuiz.id : ''}</dd>
          <dt>
            <Translate contentKey="lustPrisionApp.questionQuiz.idQuestion">Id Question</Translate>
          </dt>
          <dd>{questionQuizEntity.idQuestion ? questionQuizEntity.idQuestion.id : ''}</dd>
        </dl>
