...
export const State = (props: IStateProps) => {
  ...
  return (
    <div>
      <h2 id="state-heading">
        <Translate contentKey="lustPrisionApp.state.home.title">States</Translate>
        <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
          <FontAwesomeIcon icon="plus" />
          &nbsp;
          <Translate contentKey="lustPrisionApp.state.home.createLabel">Create new State</Translate>
        </Link>
      </h2>
        ...
        {stateList && stateList.length > 0 ? (
          <Table responsive>
            <thead>
              <tr>
                ...
                <th>
                  <Translate contentKey="lustPrisionApp.state.name">Name</Translate>
                </th>
                <th />
              </tr>
            </thead>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="lustPrisionApp.state.home.notFound">No States found</Translate>
            </div>
          )
        )}
      </div>
