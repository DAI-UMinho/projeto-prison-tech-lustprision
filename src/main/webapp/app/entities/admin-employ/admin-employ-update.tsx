...
export const AdminEmployUpdate = (props: IAdminEmployUpdateProps) => {
  ...
  const { adminEmployEntity, permissions, logins, loading, updating } = props;
        ...
        <Col md="8">
          {loading ? (
            ...
            <AvForm model={isNew ? {} : adminEmployEntity} onSubmit={saveEntity}>
              ...
              <AvGroup>
                <Label id="loginUserNameLabel" for="admin-employ-loginUserName">
                  <Translate contentKey="lustPrisionApp.adminEmploy.loginUserName">Login User Name</Translate>
                </Label>
                <AvField id="admin-employ-loginUserName" type="text" name="loginUserName" />
              </AvGroup>
              <AvGroup>
              ...
              <AvGroup>
                <Label id="permissionIdPermissionLabel" for="admin-employ-permissionIdPermission">
                  <Translate contentKey="lustPrisionApp.adminEmploy.permissionIdPermission">Permission Id Permission</Translate>
                </Label>
                <AvField id="admin-employ-permissionIdPermission" type="string" className="form-control" name="permissionIdPermission" />
              </AvGroup>
              <AvGroup>
                <Label for="admin-employ-idPermission">
                  <Translate contentKey="lustPrisionApp.adminEmploy.idPermission">Id Permission</Translate>
                </Label>
                <AvInput id="admin-employ-idPermission" type="select" className="form-control" name="idPermission.id">
                  <option value="" key="0" />
                  {permissions
