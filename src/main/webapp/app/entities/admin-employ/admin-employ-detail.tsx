    ...
    <Row>
      <Col md="8">
        ...
        <dl className="jh-entity-details">
          ...
          <dd>{adminEmployEntity.loginUserName}</dd>
          <dt>
            <span id="password">
          ...
          <dd>{adminEmployEntity.permissionIdPermission}</dd>
          <dt>
            <Translate contentKey="lustPrisionApp.adminEmploy.idPermission">Id Permission</Translate>
          </dt>
          <dd>{adminEmployEntity.idPermission ? adminEmployEntity.idPermission.id : ''}</dd>
          <dt>
